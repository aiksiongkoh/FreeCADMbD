...
std::shared_ptr<DistxyIeqJeq> DistxyIeqJeq::With(EndFrmsptr frmi, EndFrmsptr frmj)
{
    auto inst = std::make_shared<DistxyIeqJeq>(frmi, frmj);
    inst->initialize();
    return inst;
}

void DistxyIeqJeq::initialize()
{
    DistxyIeqJe::initialize();
...
void DistxyIeqJeq::calcppdistxypEIpEJ()
{
...
void DistxyIeqJeq::calcppdistxypEIpXJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpEI = xIeJeIe->pvaluepEI();
...
void DistxyIeqJeq::calcppdistxypEJpEJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpEJ = xIeJeIe->pvaluepEJ();
...
void DistxyIeqJeq::calcppdistxypXIpEJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
...
void DistxyIeqJeq::calcppdistxypXIpXJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpXI = xIeJeIe->pvaluepXI();
...
void DistxyIeqJeq::calcppdistxypXJpEJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpXJ = xIeJeIe->pvaluepXJ();
...
void DistxyIeqJeq::calcppdistxypXJpXJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpXJ = xIeJeIe->pvaluepXJ();
...
void DistxyIeqJeq::calcpdistxypEJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpEJ = xIeJeIe->pvaluepEJ();
...
void DistxyIeqJeq::calcpdistxypXJ()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpXJ = xIeJeIe->pvaluepXJ();
...
void DistxyIeqJeq::simUpdateAll()
{
    //rxyIeJe = sqrt(xIeJeIe^2 + yIeJeIe^2);
    DistxyIeqJe::simUpdateAll();
    calcpdistxypXJ();
    calcpdistxypEJ();
    calcppdistxypXIpXJ();
    calcppdistxypXIpEJ();
...
void DistxyIeqJeq::init_xyIeJeIe()
{
...
FMatDsptr DistxyIeqJeq::ppvaluepEIpEJ()
{
    return ppdistxypEIpEJ;
}

FMatDsptr DistxyIeqJeq::ppvaluepEIpXJ()
{
    return ppdistxypEIpXJ;
}

FMatDsptr DistxyIeqJeq::ppvaluepEJpEJ()
{
    return ppdistxypEJpEJ;
}

FMatDsptr DistxyIeqJeq::ppvaluepXIpEJ()
{
    return ppdistxypXIpEJ;
}

FMatDsptr DistxyIeqJeq::ppvaluepXIpXJ()
{
    return ppdistxypXIpXJ;
}

FMatDsptr DistxyIeqJeq::ppvaluepXJpEJ()
{
    return ppdistxypXJpEJ;
}

FMatDsptr DistxyIeqJeq::ppvaluepXJpXJ()
{
    return ppdistxypXJpXJ;
}

FRowDsptr DistxyIeqJeq::pvaluepEJ()
{
    return pdistxypEJ;
}

FRowDsptr DistxyIeqJeq::pvaluepXJ()
{
    return pdistxypXJ;
}
