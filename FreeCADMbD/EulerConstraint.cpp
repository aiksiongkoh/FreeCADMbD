...
std::shared_ptr<EulerConstraint> EulerConstraint::With()
{
...
std::shared_ptr<EulerConstraint> EulerConstraint::With(const std::string& str)
{
...
std::string EulerConstraint::constraintSpec()
{
