...
std::shared_ptr<EndFrameqt2> EndFrameqt2::With(const std::string& str)
{
    auto inst = std::make_shared<EndFrameqt2>(str);
    inst->initialize();
    return inst;
}

void EndFrameqt2::initpthe1x2y3zptBlks()
{
...
void EndFrameqt2::initppthe1x2y3zptptBlks()
{
    auto mbdTime = root()->time;
...
void EndFrameqt2::evalppAmeptpt()
{
