...
std::shared_ptr<DispCompIeqcJecKeqc> DispCompIeqcJecKeqc::With(EndFrmsptr frmi, EndFrmsptr frmj, EndFrmsptr frmk, size_t axisk)
{
    assert(frmi->has_qX());
    assert(!frmj->has_qX());
    assert(frmk->has_qX());
