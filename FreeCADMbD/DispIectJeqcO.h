...
namespace MbD {
    class DispIectJeqcO : public DispIecJeqcO
    {
        //prIeJeOpXJ prIeJeOpEJ pprIeJeOpEJpEJ 
    public:
        DispIectJeqcO() {}
        DispIectJeqcO(EndFrmsptr frmi, EndFrmsptr frmj) : DispIecJeqcO(frmi, frmj) {}
        static std::shared_ptr<DispIectJeqcO> With(EndFrmsptr frmi, EndFrmsptr frmj);
