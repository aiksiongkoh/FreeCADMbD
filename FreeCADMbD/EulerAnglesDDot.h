...
namespace MbD
{
    ...
    inline void EulerAnglesDDot<T>::calc()
    {
        ...
        for (size_t i = 0; i < 3; i++)
        {
            ...
            double angle, angleDot, angleDDot;
            ...
            else
            {
                ...
                angleDot = aEulerAnglesDot->at(i)->getValue();
                angleDDot = this->at(i)->getValue();
            }
            if (axis == 1)
            {
        ...
        aAddot = term->plusFullMatrix(term1)->plusFullMatrix(term2)->plusFullMatrix(term3)->plusFullMatrix(term4)->plusFullMatrix(term5)->plusFullMatrix(term6)->plusFullMatrix(term7)->plusFullMatrix(term8);
    }
