...
std::shared_ptr<OmeCompIeqJeqKeq> OmeCompIeqJeqKeq::With(EndFrmsptr frmi, EndFrmsptr frmj, EndFrmsptr frmk, size_t axisk)
{
    auto inst = std::make_shared<OmeCompIeqJeqKeq>(frmi, frmj, frmk, axisk);
    inst->initialize();
    return inst;
}
