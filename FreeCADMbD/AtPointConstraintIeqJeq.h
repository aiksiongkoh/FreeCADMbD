...
namespace MbD {
    class AtPointConstraintIeqJeq : public ConstraintIeJe
    {
    public:
        AtPointConstraintIeqJeq(EndFrmsptr frmi, EndFrmsptr frmj, size_t axisO) : axis(axisO), ConstraintIeJe(frmi, frmj) {}
