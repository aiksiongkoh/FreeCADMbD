...
std::shared_ptr<MomentOfInertiaSolver> MomentOfInertiaSolver::With()
{
...
void MomentOfInertiaSolver::example1()
{
    ...
    auto aApP = std::make_shared<EulerParameters<double>>(rotAxis, std::numbers::pi*10/180)->aA;    //Make copy of aA
...
void MomentOfInertiaSolver::doFullPivoting(size_t p) const
{
    double max = 0.0;
    auto pivotRow = p;
    auto pivotCol = p;
...
void MomentOfInertiaSolver::backSubstituteIntoDU()
{
    throw SimulationStoppingError("To be implemented.");
}

void MomentOfInertiaSolver::postSolve()
{
    throw SimulationStoppingError("To be implemented.");
}

FColDsptr MomentOfInertiaSolver::basicSolvewithsaveOriginal(FMatDsptr, FColDsptr, bool)
{
    return FColDsptr();
}

FColDsptr MomentOfInertiaSolver::basicSolvewithsaveOriginal(SpMatDsptr, FColDsptr, bool)
{
    return FColDsptr();
}

void MomentOfInertiaSolver::preSolvewithsaveOriginal(FMatDsptr, FColDsptr, bool)
{
    //Do nothing.
}

void MomentOfInertiaSolver::preSolvewithsaveOriginal(SpMatDsptr, FColDsptr, bool)
{
    //Do nothing.
}

double MomentOfInertiaSolver::getmatrixArowimaxMagnitude(size_t)
{
    return 0.0;
}

void MomentOfInertiaSolver::doPivoting(size_t)
{
    //Do nothing.
}

void MomentOfInertiaSolver::setm(double _mass)
{
    mass = _mass;
}

void MomentOfInertiaSolver::setJPP(FMatDsptr mat)
{
    aJPP = mat;
}

void MomentOfInertiaSolver::setrPoP(FColDsptr col)
{
    rPoP = col;
}

void MomentOfInertiaSolver::setAPo(FMatDsptr mat)
{
    aAPo = mat;
}

void MomentOfInertiaSolver::setrPcmP(FColDsptr col)
{
    rPcmP = col;
}

FMatDsptr MomentOfInertiaSolver::getJoo() const
{
    return aJoo;
}

DiagMatDsptr MomentOfInertiaSolver::getJpp() const
{
    return aJpp;
}

FMatDsptr MomentOfInertiaSolver::getAPp() const
{
    return aAPp;
}

void MomentOfInertiaSolver::calc()
{
    calcJoo();
    calcJpp();
    calcAPp();
...
void MomentOfInertiaSolver::calcJoo()
{
...
void MomentOfInertiaSolver::calcJpp()
{
...
void MomentOfInertiaSolver::calcAPp()
{
...
FColDsptr MomentOfInertiaSolver::eigenvectorFor(double lam)
{
    //"[aJcmP] - lam[I]."
...
void MomentOfInertiaSolver::calcJppFromDiagJcmP()
{
...
void MomentOfInertiaSolver::calcJppFromFullJcmP()
{
    //"Eigenvalues are orders from smallest to largest."
    ...
    auto piDiv3 = std::numbers::pi / 3.0;
    auto sortedJ = DiagonalMatrix<double>::With();
...
double MomentOfInertiaSolver::modifiedArcCos(double val)
{
    if (val > 1.0) {
        return 0.0;
    }
