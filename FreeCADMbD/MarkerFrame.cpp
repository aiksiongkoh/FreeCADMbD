...
MkrFrmsptr MarkerFrame::With(const std::string& str)
{
...
void MarkerFrame::initializeLocally()
{
    ...
    {
        auto eFrmc = std::dynamic_pointer_cast<EndFrame>(endFrames->at(i));
        if (eFrmc) {
            if (eFrmc->endFramet) {
                endFrames->at(i) = eFrmc->endFramet;
            }
        }
    }
...
void MarkerFrame::fillqsuWeights(DiagMatDsptr mat)
{
    endFramesDo([&](const EndFrmsptr& endFrame) {
...
void MarkerFrame::fillqsudotWeights(DiagMatDsptr mat)
{
    endFramesDo([&](const EndFrmsptr& endFrame) {
...
FMatDsptr MarkerFrame::aBOp() const
{
...
FColFMatDsptr MarkerFrame::pAOmpE() const
{
