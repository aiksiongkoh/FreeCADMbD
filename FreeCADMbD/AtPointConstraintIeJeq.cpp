...
void AtPointConstraintIeJeq::calcpGpXJ()
{
    // pGpXJ = [I];
...
void AtPointConstraintIeJeq::addToJointTorqueI(FColDsptr col)
{
...
void AtPointConstraintIeJeq::fillPosKineJacob(SpMatDsptr mat)
{
