...
std::shared_ptr<DistxyIeqJe> DistxyIeqJe::With(EndFrmsptr frmi, EndFrmsptr frmj)
{
    auto inst = std::make_shared<DistxyIeqJe>(frmi, frmj);
    inst->initialize();
    return inst;
}

void DistxyIeqJe::initialize()
{
    DistxyIeJe::initialize();
...
void DistxyIeqJe::calcppdistxypEIpEI()
{
...
void DistxyIeqJe::calcppdistxypXIpEI()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
...
void DistxyIeqJe::calcppdistxypXIpXI()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpXI = xIeJeIe->pvaluepXI();
...
void DistxyIeqJe::calcpdistxypEI()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpEI = xIeJeIe->pvaluepEI();
...
void DistxyIeqJe::calcpdistxypXI()
{
    auto x = xIeJeIe->value();
    auto y = yIeJeIe->value();
    auto pxpXI = xIeJeIe->pvaluepXI();
...
void DistxyIeqJe::simUpdateAll()
{
    //rxyIeJe = sqrt(xIeJeIe^2 + yIeJeIe^2);
    DistxyIeJe::simUpdateAll();
    calcpdistxypXI();
    calcpdistxypEI();
    calcppdistxypXIpXI();
    calcppdistxypXIpEI();
...
FMatDsptr DistxyIeqJe::ppvaluepEIpEI()
{
    return ppdistxypEIpEI;
}

FMatDsptr DistxyIeqJe::ppvaluepXIpEI()
{
    return ppdistxypXIpEI;
}

FMatDsptr DistxyIeqJe::ppvaluepXIpXI()
{
    return ppdistxypXIpXI;
}

FRowDsptr DistxyIeqJe::pvaluepEI()
{
    return pdistxypEI;
}

FRowDsptr DistxyIeqJe::pvaluepXI()
{
    return pdistxypXI;
}
