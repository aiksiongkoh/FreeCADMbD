...
namespace MbD {
    class ScrewConstraintIeqJeq : public ScrewConstraintIeqJe
    {
        //pGpXJ pGpEJ ppGpEIpXJ ppGpEIpEJ ppGpEJpEJ iqXJ iqEJ 
    public:
        ScrewConstraintIeqJeq(EndFrmsptr frmi, EndFrmsptr frmj) : ScrewConstraintIeqJe(frmi, frmj) {}
        static std::shared_ptr<ScrewConstraintIeqJeq> With(EndFrmsptr frmi, EndFrmsptr frmj);
